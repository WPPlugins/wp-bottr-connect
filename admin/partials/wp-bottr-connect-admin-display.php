    ...
    <div class="bottr-wrap col-xs-12">
        ...
        <div class="col-md-6 vertical-middle">
            <div class="bottr-hero-unit">
                ...
                <p class="bottr-title">
                    Chat bot by Bottr is a complete WordPress plugin that allows you to add your widget a.k.a your personal chat bot to your website or blog in a jiffy.
                </p>
            </div>
        </div>
        <!-- /LeftColumn -->
        ...
        <div class="col-md-6 vertical-middle bottr-col-right">
            ...
            <ul class="bottr-list">
                ...
                <li>
                    <span>
                        Train your bot by addding your blog url in the connect section (+) of your bot
                    </span>
                </li>
            </ul>
            <?php if( $exists == true ) { ?>
